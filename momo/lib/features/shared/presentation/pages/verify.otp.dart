...
class _VerifyOtpPageState extends State<VerifyOtpPage> {
  final _pinController = TextEditingController(), _formKey = GlobalKey<FormState>();
  var _loading = false;
              ...
              children: [
                ...
                Form(
                  ...
                  child: Pinput(
                    ...
                    onChanged: (input) =>
                        input.length == 6 ? _validateVerificationCode() : null,
                    autofocus: true,
  ...
  void _validateVerificationCode() async {
    if (_formKey.currentState != null && _formKey.currentState!.validate()) {
      ...
      if (_pinController.text.trim() ==
          UserSessionHandler.kSmsVerificationCode) {
